...
if __name__ == '__main__':
    ...
    parser.add_argument("--wiki_passages_dump_path", default="wiki_passages.pkl")
    parser.add_argument("--faiss_index_path", default="faiss_index.idx")
    ...
    if args.model == 'gpt':
        ...
        result = call_openai_api(queries[0], doc_lists, deployment_name)
        ...
        result = call_llama_model(queries[0], doc_lists, pipeline)
    else:
